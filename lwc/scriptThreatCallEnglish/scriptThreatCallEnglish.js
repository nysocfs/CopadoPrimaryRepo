...
import { OMNIDEF } from './scriptThreatCallEnglish_def.js';
import tmpl from './scriptThreatCallEnglish.html';
import tmpl_nds from './scriptThreatCallEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class scriptThreatCallEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
